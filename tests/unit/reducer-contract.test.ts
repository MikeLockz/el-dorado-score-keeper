...
describe('reducer contract: payload schemas', () => {
  ...
  describe('player/added', () => {
    ...
    it('rejects invalid payloads', () => {
      const invalids = [{ id: '', name: '' }, { id: 123 as any, name: 'A' }]
      for (const bad of invalids) {
        expect(() => validateEventStrict(ev('player/added', bad as any))).toThrowError(/InvalidEventPayload/)
      }
    })
  })
  ...
  describe('player/renamed', () => {
    ...
    it('rejects invalid payloads', () => {
      const invalids = [{ id: '', name: '' }, { id: 'p1', name: '' }]
      for (const bad of invalids) {
        expect(() => validateEventStrict(ev('player/renamed', bad as any))).toThrowError(/InvalidEventPayload/)
      }
    })
  })
  ...
  describe('player/removed', () => {
    ...
    it('rejects invalid payloads', () => {
      const invalids = [{ id: '' }, {}]
      for (const bad of invalids) {
        expect(() => validateEventStrict(ev('player/removed', bad as any))).toThrowError(/InvalidEventPayload/)
      }
    })
  })
  ...
  describe('score/added', () => {
    ...
    it('rejects invalid payloads', () => {
      ...
      for (const bad of invalids) {
        expect(() => validateEventStrict(ev('score/added', bad as any))).toThrowError(/InvalidEventPayload/)
      }
    })
  })
  ...
  describe('round/state-set', () => {
    ...
    it('rejects invalid payloads', () => {
      ...
      for (const bad of invalids) {
        expect(() => validateEventStrict(ev('round/state-set', bad as any))).toThrowError(/InvalidEventPayload/)
      }
    })
  })
  ...
  describe('bid/set', () => {
    ...
    it('rejects invalid payloads', () => {
      ...
      for (const bad of invalids) {
        expect(() => validateEventStrict(ev('bid/set', bad as any))).toThrowError(/InvalidEventPayload/)
      }
    })
  })
  ...
  describe('made/set', () => {
    ...
    it('rejects invalid payloads', () => {
      ...
      for (const bad of invalids) {
        expect(() => validateEventStrict(ev('made/set', bad as any))).toThrowError(/InvalidEventPayload/)
      }
    })
  })
  ...
  describe('round/finalize', () => {
    ...
    it('rejects invalid payloads', () => {
      ...
      for (const bad of invalids) {
        expect(() => validateEventStrict(ev('round/finalize', bad as any))).toThrowError(/InvalidEventPayload/)
      }
    })
  })
})
